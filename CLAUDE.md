...
Current: Clang 1756 bytes vs SDCC 1910 bytes (-8.1%) for the autoload PROM. **BIOS: Clang 5929B vs SDCC 6123B (clang 194B smaller)** as of 2026-05-03 end of session #41. cpnos-rom payload 1777B. (IX/IY reverted to reserved — allocation was incomplete, #38.) Z80 lit suite: **87/87 (86 PASS + 1 XFAIL #99)**. 25 issues open at end of session 41 (closed #116).
