...
Current: Clang 1756 bytes vs SDCC 1910 bytes (-8.1%) for the autoload PROM. **BIOS: Clang 5967B vs SDCC 6123B (clang 156B smaller)** as of 2026-05-02 (was 6021B at session #12). cpnos-rom payload 1730B. (IX/IY reverted to reserved — allocation was incomplete, #38.) Z80 lit suite: 73/73 (no XFAILs). 28 issues open (was 46 at session start), 30 closed.
