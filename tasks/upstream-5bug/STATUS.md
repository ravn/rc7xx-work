...
| 2 | TruncInstCombine Argument-leaf | **STAGED as ravn/llvm-z80#218** (2026-06-07, user-directed): iteration copy on own repo, fix-already-shipped noted, upstream permalink + "rejection happens in graph construction, before analysis" sharpening added. User iterates there; THEN move to llvm/llvm-project on user signal. Repro re-verified de59f9ed 06-07. Repro: `narrow-through-argument.ll`. |
