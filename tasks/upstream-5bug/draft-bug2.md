(For llvm/llvm-project. Staged for iteration as ravn/llvm-z80#218 — keep this file in sync with the issue; the issue body minus the staging banner is what gets filed upstream.)
