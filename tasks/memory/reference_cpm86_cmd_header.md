...
#1-#4, 09=Pure/Shared Code. (For the complete authoritative header — the fixup
pointer `ch_fixrec` at 0x7D-0x7E, the flag byte 127 at 0x7F including bit 7 =
fixups, the fixup-record format, and the base-page layout — all grounded in the
genuine CCP/M-86 2.0 OS source, see
