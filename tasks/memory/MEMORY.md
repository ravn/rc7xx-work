...
- **[rcbios CP/NET PIO PPAS stall = parked SEND→RECV mode-flip race](project_rcbios_cpnet_pio_race_parked.md) — surface before rcbios CP/NET PIO test work; NOT the 8-bit-clean bridge, pre-existing; fix is MAME z80pio mode-entry BRDY**
