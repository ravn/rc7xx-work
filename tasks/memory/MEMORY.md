...
- [llvmz80 bdos() pointer-arg scramble](reference_llvmz80_bdos_pointer_arg_scramble.md) — `bdos(func, (int)ptr)` (FCB/DMA) mis-passes func under -compiler=llvmz80; issue20 only guards int args; classic build is the working one for CP/M file-I/O tests
