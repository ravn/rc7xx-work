...
- [RC702 mame fork reconciled 2026-08-07](project_rc702_mame_fork_reconciled_2026-08-07.md) — master=upstream/master + 5 targeted commits; backup branch master-predev-2026-08-07; build now needs OSD=sdl (SDL2) + SOURCES= must list pio_port files
