# CP/M-86 toolchain log — DR C LINK-86 oracle track

Append-only research log for the CP/M-86 / RC759 toolchain used to *validate*
native wlink `.CMD` output. This is the oracle/scaffolding track; the wlink
CMD-writer plan proper lives in `wlink-cpm86-plan.md`.
