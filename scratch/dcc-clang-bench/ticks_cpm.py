...
#   llvm-objcopy -O binary /tmp/s.elf /tmp/s.bin
#   python3 -c "print(','.join(map(str,open('/tmp/s.bin','rb').read())))"
STUB = bytes([245,197,62,66,211,0,121,205,124,240,62,32,211,0,193,241,
121,183,202,174,240,254,2,40,38,254,6,40,38,254,9,40,
41,254,11,40,46,254,12,40,47,254,13,40,40,254,14,40,
37,254,25,40,33,254,26,40,28,254,108,40,34,24,92,123,
211,0,201,123,254,255,200,211,0,201,26,254,36,200,211,0,
19,24,247,175,201,201,175,201,46,34,38,0,68,125,201,33,
144,240,126,183,40,5,211,0,35,24,247,122,205,124,240,123,
205,124,240,62,93,211,0,62,10,211,0,201,245,31,31,31,
31,205,133,240,241,230,15,198,144,39,206,64,39,211,0,201,
91,49,48,56,32,114,99,61,48,120,0,237,255,62,222,50,
240,255,62,173,50,241,255,121,50,242,255,195,174,240,195,0,
0])
STUB_ORG = 0xF000
